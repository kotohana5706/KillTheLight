...
/**
 * Created by songjun on 2016-01-18.
 */
...
//        bt=new BluetoothSPP(context);
    ...
    public static final void updateAppWidget(Context context,
                                       AppWidgetManager appWidgetManager, int appWidgetId) {

        Intent recordIntent = new Intent(ACTION_CLICK);
        PendingIntent recordPendingIntent = PendingIntent.getBroadcast(context, 0, recordIntent, PendingIntent.FLAG_UPDATE_CURRENT);
//        .setOnClickPendingIntent(R.id.record_Btn, recordPendingIntent);
    }
